...
UserUrls = function(args) {
  ...
  if (args) {
    ...
    if (args.userStoreUrl !== undefined) {
      this.userStoreUrl = args.userStoreUrl;
    }
    if (args.utilityUrl !== undefined) {
      this.utilityUrl = args.utilityUrl;
    }
    if (args.messageStoreUrl !== undefined) {
      this.messageStoreUrl = args.messageStoreUrl;
    }
    if (args.userWebSocketUrl !== undefined) {
      this.userWebSocketUrl = args.userWebSocketUrl;
    }
  }
};
UserUrls.prototype = {};
UserUrls.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      ...
      case 3:
      if (ftype == Thrift.Type.STRING) {
        this.userStoreUrl = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 4:
      if (ftype == Thrift.Type.STRING) {
        this.utilityUrl = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 5:
      if (ftype == Thrift.Type.STRING) {
        this.messageStoreUrl = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 6:
      if (ftype == Thrift.Type.STRING) {
        this.userWebSocketUrl = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
UserUrls.prototype.write = function(output) {
...
AuthenticationResult.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 10:
      if (ftype == Thrift.Type.STRUCT) {
        this.urls = new UserUrls();
        this.urls.read(input);
      } else {
        input.skip(ftype);
      }
      break;
...
BootstrapSettings = function(args) {
  ...
  if (args) {
    ...
    if (args.enableGoogle !== undefined) {
...
BootstrapSettings.prototype.read = function(input) {
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      case 16:
      if (ftype == Thrift.Type.BOOL) {
        this.enableGoogle = input.readBool().value;
      } else {
        input.skip(ftype);
      }
      break;
